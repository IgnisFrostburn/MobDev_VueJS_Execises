<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true">
      ...
      <ion-list>
        <ion-item v-for="task in doneTasks" :key="task.id">
          <ion-checkbox slot="start" :checked="true" @ionChange="toggleTask(task.id)" />
...
const doneTasks = computed(() => tasks.value.filter((t: { done: boolean }) => t.done));
</script>
