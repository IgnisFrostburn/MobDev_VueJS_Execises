...
.error-banner { background: #fef3c7; border: 1px solid #f59e0b; border-radius: 6px; padding: 10px 14px; margin-bottom: 16px; margin-top: 40px; color: #92400e; font-size: 14px; }
.page-nav { margin-bottom: 20px; margin-top: 30px; }
.page-nav a { color: #42B883; text-decoration: none; font-weight: 600; }
.page-nav button a { color: white; text-decoration: none; }
.task-list { list-style: none; padding: 0; margin: 0; }
.task-list a { text-decoration: none; color: inherit; display: flex; flex-direction: row; justify-content: space-between; align-items: center; width: 100%; }
.priority { font-size: 12px; color: #6b7280; text-transform: capitalize; }
...
button { background: #42B883; color: white; border: none; padding: 8px 16px; border-radius: 6px; cursor: pointer; font-size: 14px; }
button:hover { background-color: #37996d;}
</style>
